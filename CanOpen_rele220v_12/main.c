...
const 
uint32_t    N1000_Device_Type = 30191; 
                   /*
                        1001_Error_Registr
                        Bit Definition
                        0 Generic error
                  ...
                  */
 uint8_t     N1001_Error_Registr = 0;
 uint32_t   N1003_error_field = 0;
                  /*
                          30 Generate
                  ...
                  */
 uint32_t   N1005_cob_id_sync = 0;
 uint32_t   N1006_Comm_cycle_period = 0;
 uint32_t   N1007_Sync_window_len = 0;
 const 
 uint32_t   N1008_Device_name = 0;
 const 
 uint32_t   N1009_Hardware_version = 0;
 const 
 uint32_t   N100A_Software_version = 0;
 uint16_t   N100C_Guard_Time = 0;
 uint8_t     N100D_Life_Time_Factor = 0;
 uint32_t   N1010_value[4] = {
                            0,   // save all parameters
                            0,   // save communication parameters
                            0,   // save application parameters
                            0}; // save manufacturer defined parameters
 uint32_t   N1011_value[3] = {
                            0,   // Restore all default parameters
                            0,   // restore Index 1000h - 1FFFh
                            0}; // restore Index 6000h - 9FFFh
uint32_t    N1014_cob_id_EMCY = 0;
uint16_t    N1015_Inhibit_Time_EMCY = 0;
                        /*N1016
                            31. . . 24 Reserved ?
                            23. . . 16 Node ID Heartbeat Producer Node ID
                            15. . . 0 Heartbeat time Time in 1ms*/
uint32_t    N1016_Consumer_heartbeat_time_value={0};
uint16_t    N1017_Producer_heartbeat_time = 0;

uint32_t    N1018_value[4] ={
                         0,   // The Vendor ID
                         0,   // Product code
                         0,   // Revision number
                         0}; // Serial number
uint8_t      N1029_Communication_Error_value[4] = {
                        //0 = Pre-Operational, 1 = No State Change, 2 = Stop
...
// CIA 301
 ...
 //  PDO 1600 
uint32_t  pdo1_map_output[2] ={0x63000110,0};
//  PDO 1A00
uint32_t  pdo1_map_input [2] = {0x60000101,0}; 

// CIA 401


uint16_t gpio_output = 0;
uint16_t gpio_output_old = 0;
uint16_t gpio_polary_output = 0;
uint16_t gpio_mask_output   = 0;
uint8_t   gpio_input = 0; 
uint8_t   gpio_polary_input = 0;
uint8_t   gpio_mask_input   = 0;
...
struct OD_array_n   
//save 65h_76h_61h_73h, load 64h_61h_6Fh_6Ch
